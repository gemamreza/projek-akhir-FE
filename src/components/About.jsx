        ...
        return (
            <div className="container ">
                ...
                <p style={{fontFamily:"sans-serif", textAlign:"justify", fontSize:"20px", display:"block"}}>
                   Lokalmarket adalah website ecommerce pertama di Indonesia yang menjual
                ...
                <p  style={{fontFamily:"sans-serif", textAlign:"justify", fontSize:"20px", display:"block"}}>
                   Lokalmarket is the first ecommerce website in Indonesia that sells
